...
async def main():
    ...
    for e_codeSystem in list_codeSystems :
        ...
        if(not os.path.isfile('../DM/fsh-generated/resources/CodeSystem-'+ e_codeSystem["id"] + ".json")) :
            ...
            try:
                if(( CodeSystem["count"] > 5000) or (e_codeSystem["name"] == "TRE_R13_CommuneOM") or (e_codeSystem["name"] == "NUVA") or (e_codeSystem["name"] == "CISP_2") or (e_codeSystem["name"] == "Standard_terms_EDQM")  )   :

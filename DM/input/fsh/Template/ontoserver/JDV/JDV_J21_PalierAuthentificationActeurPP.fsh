...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.5.2.1.1"
...
* $TRE-R231-PalierAuthentification#APPPUBP2 "Palier 2 de l'authentification publique des acteurs sanitaires, médico-sociaux et sociaux personnes physiques"
* $TRE-R231-PalierAuthentification#APPPUBP3 "Palier 3 de l'authentification publique des acteurs sanitaires, médico-sociaux et sociaux personnes physiques"
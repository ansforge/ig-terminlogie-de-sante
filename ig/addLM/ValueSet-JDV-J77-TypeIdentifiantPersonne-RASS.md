# JDV_J77_TypeIdentifiantPersonne_RASS - Terminologies de Santé v1.4.0
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_G08-TypeIdentifiantPersonne/FHIR/TRE-G08-TypeIdentifiantPersonne`](CodeSystem-TRE-G08-TypeIdentifiantPersonne.md)version 📦20240329120000

 

### Expansion

Expansion effectuée en interne basée sur [codesystem TRE_G08_TypeIdentifiantPersonne v20240329120000 (CodeSystem)](CodeSystem-TRE-G08-TypeIdentifiantPersonne.md)

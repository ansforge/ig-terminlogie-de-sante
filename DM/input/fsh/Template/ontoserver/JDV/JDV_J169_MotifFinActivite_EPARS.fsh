...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.6.1.230"
...
* $TRE-R25-MotifFinActivite#CHP "Changement de profession"
* $TRE-R25-MotifFinActivite#DCD "Décès"
* $TRE-R25-MotifFinActivite#ETR "Départ à l'étranger"
* $TRE-R25-MotifFinActivite#RH "Retraite hospitalière"
* $TRE-R25-MotifFinActivite#RL "Retraite libérale"
* $TRE-R25-MotifFinActivite#RS "Retraite salariée"
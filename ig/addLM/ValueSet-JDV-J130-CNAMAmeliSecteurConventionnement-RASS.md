# JDV_J130_CNAMAmeliSecteurConventionnement_RASS - Terminologies de Santé v1.4.0
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_R282-CNAMAmeliSecteurConventionnement/FHIR/TRE-R282-CNAMAmeliSecteurConventionnement`](CodeSystem-TRE-R282-CNAMAmeliSecteurConventionnement.md)version 📦20231215120000

 

### Expansion

Expansion effectuée en interne basée sur [codesystem TRE_R282_CNAMAmeliSecteurConventionnement v20231215120000 (CodeSystem)](CodeSystem-TRE-R282-CNAMAmeliSecteurConventionnement.md)

# ValueSet_NUVA_All - Terminologies de Santé v1.3.0
...
| Active as of 2025-10-25 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:ValueSet_NUVA_All |
...
* Include tous les codes définis dans [`https://smt.esante.gouv.fr/terminologie-nuva`](CodeSystem-terminologie-nuva.md)version Not Stated (use latest from terminology server)

 

### Expansion

Expansion from smt.esante.gouv.fr based on [system Nomenclature Unifiée des Vaccins v1.0.1009 (CodeSystem)](CodeSystem-terminologie-nuva.md)

# x_BasicConfidentialityKind - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-hl7-v3-xBasicConfidentialityKind-cisis | *Version*:20260311144903 | |
| Active as of 2026-03-11 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:XBasicConfidentialityKind |
...
```json
{
  ...
  "meta" : {
    "versionId" : "7",
    "lastUpdated" : "2026-03-11T15:29:41.561+01:00",

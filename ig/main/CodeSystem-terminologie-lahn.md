# Liste des Actes Inovants Hors Nomenclature - Terminologies de Santé v1.4.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/terminologie-lahn | *Version*:2024 v1.0 | |
| Active as of 2024-10-09 | *Responsible:*Agence du numérique en santé | *Computable Name*:LAHN |
...
```json
{
  ...
  "meta" : {
    "versionId" : "3",
    "lastUpdated" : "2025-10-16T10:46:39.308+02:00",
    "profile" : [
  ...
  "concept" : [
    {
      ...
      "property" : [
        ...
        {
          "code" : "created",
          "valueDateTime" : "2024-01-01T00:00:00+00:00"
        },
        {
          "code" : "type",
          "valueString" : "LC"
    ...
    },
    {
      ...
      "property" : [
        ...
        {
          "code" : "note",
          "valueString" : "Hors BCR-ABL [N407]. Par exemple :  CCND1, EVI1, TLX1/3, CRLF, DEK-CAN, STAT3, FLT3…"
        },
        {
          "code" : "prixMaximal",
          "valueDecimal" : 113.4
    ...
    },
    {
      ...
      "property" : [
        ...
        {
          "code" : "note",
          "valueString" : "Indications : hors indications des actes 4087 et 4088 de la NABM et selon les recommandations de la HAS"
        },
        {
          "code" : "prixMaximal",
          "valueDecimal" : 362.88
    ...
    },
    {
      ...
      "property" : [
        ...
        {
          "code" : "note",
          "valueString" : "Cancer du poumon pour la prescription d'inhibiteurs de ROS1"
        },
        {
          "code" : "prixMaximal",
          "valueDecimal" : 110.7
    ...
    {
      "code" : "K197",
      "display" : "Dosages des fragments d’activation du Complément, C5a, C3a, soluble C5b9,  Bb (par protéine)",
      "property" : [
        {
          "code" : "parent",
          "valueCode" : "11-02"
    ...
    {
      "code" : "K196",
      "display" : "C1r, C1s, C2, MBL, antigénémie",
      "property" : [
        {
          "code" : "parent",
          "valueCode" : "11-02"
    ...
    },
    {
      ...
      "property" : [
        ...
        {
          "code" : "note",
          "valueString" : "Concerne un nombre limité de maladies héréditaires pour lesquelles la détection des mutation par expansion de microsatellites reste nécessaire au diagnostic (ex: maladie de Huntington)"
        },
        {
          "code" : "prixMaximal",
          "valueDecimal" : 137.7
    ...
    {
      "code" : "K198",
      "display" : "Dosage du complément total, voie classique, voie des lectines et voie alterne par technique non hémolytique",
      "property" : [
        {
          "code" : "parent",
          "valueCode" : "11-02"
    ...
    },
    {
      ...
      "property" : [
        ...
        {
          "code" : "note",
          "valueString" : "Cancer du poumon pour la prescription d'inhibiteurs d'ALK"
        },
        {
          "code" : "prixMaximal",
          "valueDecimal" : 110.7

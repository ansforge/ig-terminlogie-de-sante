# JDV-ModeleDocumentCDANonStructure - Terminologies de Santé (Publiées par l'ANS) v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JDV-ModeleDocumentCDANonStructure**

## ValueSet: JDV-ModeleDocumentCDANonStructure 
...
| Active as of 2026-04-22 | *Computable Name*:JDV_TRE_R221_ModeleDocumentCDANonStructure |
...
```json
{
  ...
  "version" : "1.1.0",
  "name" : "JDV_TRE_R221_ModeleDocumentCDANonStructure",
  "title" : "JDV-ModeleDocumentCDANonStructure",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-04-22T10:01:26+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{

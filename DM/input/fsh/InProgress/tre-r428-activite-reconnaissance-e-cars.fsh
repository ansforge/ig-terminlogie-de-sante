...
Description: "liste des activites autorisees/exercées  à reconnaissance en provenance de E-CARS "
* ^meta.versionId = "8"
...
* ^url = "https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r428-activite-reconnaissance-e-cars"
...
* #XX_02   "Infections ostéo-articulaires complexes"
...
* #XX_03   "Plateau technique hautement spécialisé"
...
* #XX_07   "Traitements médicamenteux systémiques du cancer (TMSC) Structures « dites associées »"
...
* #XX_08   "Soins Médicaux et de Réadaptation "
...
* #XX_10   "Centre de maladies rares"
...
* #XX_12   "Prise en charge de la douleur chronique rebelle"
...
* #XX_13   "Prise en charge des patients atteints d’obésité sévère ou multi-compliquée"
...
* #XX_14   "Prise en charge des personnes âgées"
...
* #XX_15   "Maladies neuro dégénératives"
...
* #XX_17   "Soins de Rééducation Post-Réanimation"
...
* #XX_18   "Structure spécifique d'hospitalisation"
...
* #XX_19   "Prise en charge des violences"
...
* #XX_21   "TCA (Trouble du comportement alimentaire)"
...
* #XX_24   "Périnatalité - pédiatrie – enfance - santé de la mère et de la femme"
...
* #XX_27   "Implantation cochléaire et du tronc cérébral"

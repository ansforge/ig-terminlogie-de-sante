# JDV Imagerie Objectif Reference CISIS - Terminologies de Santé v1.4.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-imagerie-objectif-reference-cisis | *Version*:20251028115833 | |
| Active as of 2025-10-28 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvImagerieObjectifReferenceCisis |
...
* [FR-DICOM-Objectifs-de-reference](StructureDefinition-fr-dicom-objectifs-de-reference.md)
...
```json
{
  ...
  "meta" : {
    "versionId" : "5",
    "lastUpdated" : "2025-10-29T10:43:53.166+01:00",
    "profile" : [

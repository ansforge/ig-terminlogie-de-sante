# JDV_J186_ProfessionRessource_ROR - Terminologies de Santé v1.4.0
...
version : 12; Dernière mise à jour : 2025-07-25 09:32:12+0000; Langue : fr-FR
...
* Inclut ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_R356-ProfessionRessource/FHIR/TRE-R356-ProfessionRessource`](CodeSystem-TRE-R356-ProfessionRessource.md)version 📦20250918120000 
...
* [codesystem TRE_R356_ProfessionRessource v20250918120000 (CodeSystem)](CodeSystem-TRE-R356-ProfessionRessource.md)
...
Ce jeu de valeur (ValueSet) contient 149 concepts

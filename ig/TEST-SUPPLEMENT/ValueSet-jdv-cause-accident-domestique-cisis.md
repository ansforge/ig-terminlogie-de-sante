# JDV Cause Accident Domestique CISIS - Terminologies de Santé v1.3.0
...
* Inclut ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://smt.esante.gouv.fr/terminologie-cim11-mms`](CodeSystem-terminologie-cim11-mms.md)version Not Stated (use latest from terminology server) 

...
ValueSet: TreR366TypeObjetAll
Id: tre-r366-type-objet-all
Title: "Tre R366 Type Objet All"
Description: "Jeu de valeurs ALL contenant les types d'objet enregistrés et manipulés dans FINESS+."
* ^meta.versionId = "1"
...
* ^url = "https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r366-type-objet?vs"
...
* include codes from system $tre-r366-type-objet
# SpecimenAdditiveEntity - Terminologies de Santé v1.3.0
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`http://terminology.hl7.org/CodeSystem/v3-EntityCode`](http://terminology.hl7.org/6.5.0/CodeSystem-v3-EntityCode.html)version 📦3.0.0

...
ValueSet: TreR384PratiqueTherapeutiqueSpecifiqueActDeSoinAmmAll
Id: tre-r384-pratique-therapeutique-specifique-act-de-soin-amm-all
Title: "Tre R384 Pratique Therapeutique Specifique Act De Soin Amm All"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.6.1.356"
* ^version = "20250222120000"
* ^status = #active
* ^experimental = false
* ^date = "2025-02-22T18:02:28.249+00:00"
* ^publisher = "Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris"
* include codes from system $tre-r384-pratique-therapeutique-specifique-act-de-soin-amm
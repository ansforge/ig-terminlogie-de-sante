...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.35"
...
* $TRE-R207-TypeOrganisationInterne#4 "Unité élémentaire"
* $TRE-R67-TypeStructure-EJ-EG#EJ "Entité juridique"
* $TRE-R67-TypeStructure-EJ-EG#EG "Etablissement géographique"
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_R253-TypeMaternite/FHIR/TRE-R253-TypeMaternite`](CodeSystem-TRE-R253-TypeMaternite.md)version 📦20231215120000

 

### Expansion

Expansion effectuée en interne basée sur [codesystem TRE_R253_TypeMaternite v20231215120000 (CodeSystem)](CodeSystem-TRE-R253-TypeMaternite.md)

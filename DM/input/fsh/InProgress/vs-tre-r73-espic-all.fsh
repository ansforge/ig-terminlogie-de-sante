...
ValueSet: VsTreR73EspicAll
Id: vs-tre-r73-espic-all
Title: "Vs Tre R73 Espic All"
Description: "Jeu de valeurs ALL contenant les établissements de santé privés d'intérêt collectif"
* ^meta.versionId = "1"
...
* include codes from system $tre-r73-espic
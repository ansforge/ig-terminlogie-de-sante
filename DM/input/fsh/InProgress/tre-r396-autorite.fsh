...
Cette TRE comporte de nouvelles Proprietes métier : indicateur Autorité de régulation ou Autorité d'enregistrement dans un contexte donné ; 
Remarque : Refonte Finess+ - Cette TRE annule et remplace les 3 TRE TRE-R60-Autorite, TRE-R90-TypeAE, TRE-R82-Ordre. Ces TRE restent actives et actualisées à cejour mais vous êtes invités à ne plus les utiliser 
"""
* ^meta.versionId = "8"
...
* #CNOM ^property[+].code = #autoriteRegulationFiness
...
* #CNOMK ^property[+].code = #autoriteRegulationFiness
...
* #CNOP ^property[+].code = #autoriteRegulationFiness
...
* #CNOPP ^property[+].code = #autoriteRegulationFiness
...
* #CNOSF ^property[+].code = #autoriteRegulationFiness
...
* #ENREG ^property[+].code = #autoriteRegulationFiness
...
* #ONCD ^property[+].code = #autoriteRegulationFiness
...
* #ONI ^property[+].code = #autoriteRegulationFiness
...
* #SSA ^property[+].code = #autoriteRegulationFiness

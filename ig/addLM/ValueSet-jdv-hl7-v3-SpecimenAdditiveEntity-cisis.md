# SpecimenAdditiveEntity - Terminologies de Santé v1.4.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-hl7-v3-SpecimenAdditiveEntity-cisis | *Version*:20251028115833 | |
| Active as of 2025-10-28 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:SpecimenAdditiveEntity |
...
version : 5; Dernière mise à jour : 2025-10-29 10:45:23+0100; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`http://terminology.hl7.org/CodeSystem/v3-EntityCode`](http://terminology.hl7.org/7.0.0/CodeSystem-v3-EntityCode.html)version 📦3.0.0

 

### Expansion

Expansion effectuée en interne basée sur [codesystem EntityCode v3.0.0 (CodeSystem)](http://terminology.hl7.org/7.0.0/CodeSystem-v3-EntityCode.html)

Ce jeu de valeur (ValueSet) contient 54 concepts
...
```json
{
  ...
  "meta" : {
    "versionId" : "5",
    "lastUpdated" : "2025-10-29T10:45:23.713+01:00",
    "profile" : [

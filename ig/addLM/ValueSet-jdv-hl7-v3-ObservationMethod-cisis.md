# ObservationMethod - Terminologies de Santé v1.4.0
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`http://terminology.hl7.org/CodeSystem/v3-ObservationMethod`](http://terminology.hl7.org/7.0.0/CodeSystem-v3-ObservationMethod.html)version 📦3.0.0
...
* [codesystem ObservationMethod v3.0.0 (CodeSystem)](http://terminology.hl7.org/7.0.0/CodeSystem-v3-ObservationMethod.html)
* [supplement ObservationMethodSupplementFr v1.0 (CodeSystem)](CodeSystem-ObservationMethod-supplement-fr.md)

Ce jeu de valeur (ValueSet) contient 269 concepts

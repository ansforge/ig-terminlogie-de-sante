# JDV_J159_MethodPainSeverity_ENS - Terminologies de Santé v1.4.0
...
version : 4; Dernière mise à jour : 2025-07-02 17:05:16+0000; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans `https://smt.esante.gouv.fr/terminologie-ncit`version Non précisé (utilise la dernière version provenant du serveur de terminologie)

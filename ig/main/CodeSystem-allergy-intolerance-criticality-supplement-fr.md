# AllergyIntoleranceCriticalitySupplementFr - Terminologies de Santé v1.4.0
...
This code system supplement `https://smt.esante.gouv.fr/fhir/CodeSystem/allergy-intolerance-criticality-supplement-fr` defines labels on the following codes:

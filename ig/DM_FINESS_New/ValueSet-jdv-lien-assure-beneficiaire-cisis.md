# JDV Lien Assure Beneficiaire CISIS - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-lien-assure-beneficiaire-cisis | *Version*:20260420150251 | |
| Active as of 2026-04-20 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvLienAssureBeneficiaireCisis |
...
```json
{
  ...
  "meta" : {
    "versionId" : "9",
    "lastUpdated" : "2026-04-20T16:58:19.633+02:00",

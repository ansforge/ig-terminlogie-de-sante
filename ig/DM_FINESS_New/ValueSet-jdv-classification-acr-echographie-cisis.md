# JDV Classification Acr Echographie CISIS - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-classification-acr-echographie-cisis | *Version*:20260311144902 | |
| Active as of 2026-03-11 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvClassificationAcrEchographieCisis |
...
```json
{
  ...
  "meta" : {
    "versionId" : "7",
    "lastUpdated" : "2026-03-11T15:28:02.593+01:00",

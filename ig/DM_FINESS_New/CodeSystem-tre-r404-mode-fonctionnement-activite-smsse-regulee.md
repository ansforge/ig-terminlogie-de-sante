# Tre R404 Mode Fonctionnemet Activite Smsse Regulee - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r404-mode-fonctionnement-activite-smsse-regulee | *Version*:20251105120000 | |
| Active as of 2025-11-05 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TreR404ModeFonctionnemetActiviteSmsseRegulee |
...
```json
{
  ...
  "meta" : {
    "versionId" : "1",
    "lastUpdated" : "2025-11-05T05:12:17.936+00:00",
    "profile" : [

# JDV Methode Accouchement CISIS - Terminologies de Santé v1.3.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-methode-accouchement-cisis | *Version*:20250624152101 | |
| Active as of 2025-06-24 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvMethodeAccouchementCisis |
...
version: 3; Dernière mise à jour : 2025-06-25 09:14:50+0000; Langue : fr-FR
...
```json
{
  ...
  "meta" : {
    "versionId" : "3",
    "lastUpdated" : "2025-06-25T09:14:50.941+00:00",
    ...
    "include" : [
      ...
      },
      {
        ...
        "concept" : [
          ...
          {
            "code" : "236974004",
            "display" : "voie basse instrumentale"
          }
        ]
      }
    ]

# PersonalRelationshipRoleType - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-hl7-v3-PersonalRelationshipRoleType-cisis | *Version*:20251216141838 | |
| Active as of 2025-12-16 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:PersonalRelationshipRoleType |
...
```json
{
  ...
  "meta" : {
    "versionId" : "6",
    "lastUpdated" : "2025-12-17T15:48:36.429+01:00",

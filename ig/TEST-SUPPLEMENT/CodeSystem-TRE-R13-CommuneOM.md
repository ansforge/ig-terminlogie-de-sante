# TRE_R13_CommuneOM - Terminologies de Santé v1.3.0
...
This case-insensitive code system `https://mos.esante.gouv.fr/NOS/TRE_R13-CommuneOM/FHIR/TRE-R13-CommuneOM` defines codes, but no codes are represented here

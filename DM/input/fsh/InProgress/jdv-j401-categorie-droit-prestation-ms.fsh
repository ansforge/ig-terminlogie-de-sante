ValueSet: JdvJ401CategorieDroitPrestationMs
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.241"
...
* include codes from system  https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r420-droit-prestation where niveau = "1"

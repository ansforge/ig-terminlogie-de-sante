# JDV_J22_RestrictionAudienceVIHF_CISIS - Terminologies de Santé v1.4.0
...
version : 4; Dernière mise à jour : 2025-07-02 17:05:59+0000; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_A07-StatutVisibiliteDocument/FHIR/TRE-A07-StatutVisibiliteDocument`](CodeSystem-TRE-A07-StatutVisibiliteDocument.md)version 📦20231215120000

 

### Expansion

Expansion effectuée en interne basée sur [codesystem TRE_A07_StatutVisibiliteDocument v20231215120000 (CodeSystem)](CodeSystem-TRE-A07-StatutVisibiliteDocument.md)

# Jdv J418 Activite Sanitaire Diverse Regulee Active - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j418-activite-sanitaire-diverse-regulee-active | *Version*:20260421120000 | |
| Active as of 2026-04-21 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvJ418ActiviteSanitaireDiverseReguleeActive |
...
```json
{
  ...
  "id" : "jdv-j418-activite-sanitaire-diverse-reguleeActive",
  "meta" : {
    "versionId" : "1",

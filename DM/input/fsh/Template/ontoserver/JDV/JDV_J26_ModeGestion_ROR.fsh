...
* ^meta.versionId = "4"
* ^meta.lastUpdated = "2025-07-02T17:06:18.326+00:00"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.3.24"
...
* $TRE-R236-ModeGestion#01 "Prestataire"
* $TRE-R236-ModeGestion#02 "Mandataire"
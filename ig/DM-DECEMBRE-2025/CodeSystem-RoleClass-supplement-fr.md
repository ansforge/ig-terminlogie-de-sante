# RoleClassSupplementFr - Terminologies de Santé v1.4.0
...
This code system supplement `https://smt.esante.gouv.fr/fhir/CodeSystem/roleClass-supplement-fr` defines labels on the following codes:

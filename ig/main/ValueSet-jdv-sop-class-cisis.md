...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans `http://​dicom.​nema.​org/​medical/​dicom/​current/​output/​chtml/​part06/​chapter_A.html`version Not Stated (use latest from terminology server)

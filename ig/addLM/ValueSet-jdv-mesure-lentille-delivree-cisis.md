# JDV Mesure Lentille Delivree CISIS - Terminologies de Santé v1.4.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-mesure-lentille-delivree-cisis | *Version*:20250624152059 | |
| Active as of 2025-06-24 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvMesureLentilleDelivreeCisis |
...
* [FR-Mesure-dispositif-oculaire](StructureDefinition-fr-mesure-dispositif-oculaire.md)
...
version : 4; Dernière mise à jour : 2025-06-25 09:14:47+0000; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

Ce jeu de valeur (ValueSet) inclut les codes selon les règles suivantes :

* Inclut ce(s) code(s) tel quil(s) est (sont) défini(s) dans `https://smt.esante.gouv.fr/terminologie-ncit`version Non précisé (utilise la dernière version provenant du serveur de terminologie)
...
```json
{
  ...
  "meta" : {
    "versionId" : "4",
    "lastUpdated" : "2025-06-25T09:14:47.578+00:00",
    "profile" : [

# JDV Motif Mise A Jour CISIS - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-motif-mise-a-jour-cisis | *Version*:20251216141839 | |
| Active as of 2025-12-16 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvMotifMiseAJourCisis |
...
```json
{
  ...
  "meta" : {
    "versionId" : "5",
    "lastUpdated" : "2025-12-17T15:45:33.469+01:00",

...
* include codes from system $tre-r66-categorie-entite-geographique-exercice
* exclude codes from system $tre-r66-categorie-entite-geographique-exercice where finess = "false"
...
* ^meta.versionId = "4"
* ^meta.lastUpdated = "2025-07-02T17:06:25.328+00:00"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.3.32"
...
* $TRE-R240-TemporaliteAccueil#01 "Temporaire"
* $TRE-R240-TemporaliteAccueil#02 "Permanent"
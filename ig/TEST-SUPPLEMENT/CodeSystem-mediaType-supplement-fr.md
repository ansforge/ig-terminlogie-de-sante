...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/example/CodeSystem/mediaType-supplement-fr | *Version*:1.0 |
...
This code system supplement `http://hl7.org/fhir/us/example/CodeSystem/mediaType-supplement-fr` defines labels on the following codes:
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/us/example/CodeSystem/mediaType-supplement-fr",
  "version" : "1.0",

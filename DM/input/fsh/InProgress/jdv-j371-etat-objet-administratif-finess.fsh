Alias: $tre-r365-etat-objet-administratif = https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r365-etat-objet-administratif
...
* include codes from system $tre-r365-etat-objet-administratif where finess = "true"

...
* ^meta.versionId = "5"
* ^meta.lastUpdated = "2026-03-27T11:18:05.976+01:00"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.7"
...
* $TRE-R227-ChampActivite#04 "Médico-social (MS)"
* $TRE-R227-ChampActivite#05 "Ville"
* $TRE-R227-ChampActivite#06 "Social"
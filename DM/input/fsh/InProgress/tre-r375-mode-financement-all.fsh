...
ValueSet: TreR375ModeFinancementAll
Id: tre-r375-mode-financement-all
Title: "Tre R375 Mode Financement All"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.6.1.363"
* ^version = "20250222120000"
* ^status = #active
* ^experimental = false
* ^date = "2025-02-22T18:02:28.249+00:00"
* ^publisher = "Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris"
* include codes from system $tre-r375-mode-financement
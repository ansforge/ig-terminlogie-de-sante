...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.55"
...
* $TRE-R201-TypeDivisionTerritoriale#4 "Territoire de Santé"
* $TRE-R201-TypeDivisionTerritoriale#5 "Pays"
* $TRE-R201-TypeDivisionTerritoriale#6 "Zone de Défense"
...
* ^property[=].type = #dateTime
* ^property[+].code = #JdvJ352NatureCapaciteFiness
* ^property[=].uri = "http://hl7.org/fhir/concept-properties#JdvJ352NatureCapaciteFiness"
...
* #02 ^property[+].code = #JdvJ352NatureCapaciteFiness
...
* #03 ^property[+].code = #JdvJ352NatureCapaciteFiness

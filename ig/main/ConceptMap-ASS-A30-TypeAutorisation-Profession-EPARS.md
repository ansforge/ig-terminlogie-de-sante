# ASS_A30_TypeAutorisation_Profession_EPARS - Terminologies de Santé v1.4.0
...
* **Code source**: AM01 (Autorisation de plein exercice)
  ...
  * **Code cible**: 91 (Orthophoniste)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 26 (Audioprothésiste)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 28 (Opticien-Lunetier)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 81 (Orthoprothésiste)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 82 (Podo-Orthésiste)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 83 (Orthopédiste-Orthésiste)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 84 (Oculariste)
* **Code source**: AM01 (Autorisation de plein exercice)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 85 (Epithésiste)
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 86 (Technicien de laboratoire médical)
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 91 (Orthophoniste)
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 98 (Manipulateur ERM)
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 26 (Audioprothésiste)
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
...
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 82 (Podo-Orthésiste)
* **Code source**: AM22 (Agrément Caisse Régionale d'Assurance Maladie)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 81 (Orthoprothésiste)
* **Code source**: AM22 (Agrément Caisse Régionale d'Assurance Maladie)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
...
* **Code source**: AM22 (Agrément Caisse Régionale d'Assurance Maladie)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 85 (Epithésiste)
* **Code source**: AM23 (Agrément Ministère des anciens combattants)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 81 (Orthoprothésiste)
* **Code source**: AM23 (Agrément Ministère des anciens combattants)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
...
* **Code source**: AM23 (Agrément Ministère des anciens combattants)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 85 (Epithésiste)
* **Code source**: AM24 (Exerce comme tech lab avant le 08/11/1976)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 86 (Technicien de laboratoire médical)
* **Code source**: AM25 (Exerce comme tech lab au 29/11/1997)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 86 (Technicien de laboratoire médical)
* **Code source**: AM26 (Exerce comme tech lab au 30/05/2013)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 86 (Technicien de laboratoire médical)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 31 (Assistant dentaire)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 86 (Technicien de laboratoire médical)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
...
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 92 (Orthoptiste)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 94 (Ergothérapeute)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 95 (Diététicien)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 96 (Psychomotricien)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 98 (Manipulateur ERM)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
...
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 32 (Physicien médical)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 81 (Orthoprothésiste)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
...
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 85 (Epithésiste)
* **Code source**: AM29 (Autorisation titre diététicien décision admin 86)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 95 (Diététicien)
* **Code source**: AM30 (Autorisation titre diététicien emploi permanent 86)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 95 (Diététicien)
* **Code source**: AM34 (Diplôme, certificat ou titre permettant d'exercer la médecine en France)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 26 (Audioprothésiste)
* **Code source**: AM36 (Autorisation d'exercice d'épithésiste pour chirurgien-dentiste)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 85 (Epithésiste)
* **Code source**: AM37 (Autorisation épithésiste pour médecin stomatologue ou chirurgie maxillo-faciale)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 85 (Epithésiste)
* **Code source**: AM38 (Arrêté de nomination de MER du Secteur Public)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 98 (Manipulateur ERM)
* **Code source**: AM41 (Agrément de radiophysicien avant le 28/11/2004)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 32 (Physicien médical)
...
* **Code source**: AM14 (Arrangement France-Québec (art L 4111-3-1 CSP))
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 41 (Assistant de service social)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 41 (Assistant de service social)
...
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 71 (Ostéopathe)
* **Code source**: AM27 (Autorisation d'exercice UE/EEE)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 73 (Chiropracteur)
* **Code source**: AM28 (Autorisation d'user du titre d'Ostéopathe)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 71 (Ostéopathe)
* **Code source**: AM31 (Autorisation d'exercice de psychologue diplôme étranger)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 93 (Psychologue)
* **Code source**: AM32 (Autorisation préfectorale d'exercice de psychologue décret 90-259)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 93 (Psychologue)
* **Code source**: AM33 (Docteur en médecine spécialité psychiatrie)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 72 (Psychothérapeute)
* **Code source**: AM35 (Autorisation d'user du titre de Chiropraxie)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 73 (Chiropracteur)
* **Code source**: AM39 (Docteur en médecine + formation + stage)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 72 (Psychothérapeute)
* **Code source**: AM42 (Autorisation d'user du titre de Psychothérapeute)
  * **relation**: [is equivalent to](http://hl7.org/fhir/R5/codesystem-concept-map-relationship.html#equivalent)
  * **Code cible**: 72 (Psychothérapeute)

ValueSet: JdvJ395NatureDemandeCompensationMs
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.235"
...
* include codes from system https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r418-nature-demande-compensation
    where status = "active"
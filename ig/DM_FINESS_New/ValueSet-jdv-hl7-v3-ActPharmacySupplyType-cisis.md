# ActPharmacySupplyType - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-hl7-v3-ActPharmacySupplyType-cisis | *Version*:20260420150251 | |
| Active as of 2026-04-20 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:ActPharmacySupplyType |
...
```json
{
  ...
  "meta" : {
    "versionId" : "9",
    "lastUpdated" : "2026-04-20T16:57:27.310+02:00",

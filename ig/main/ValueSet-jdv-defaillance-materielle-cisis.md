# JDV Defaillance Materielle CISIS - Terminologies de Santé v1.3.0
...
* Inclut ce(s) code(s) tel quil(s) est (sont) défini(s) dans `https://www.imdrf.org`version Not Stated (use latest from terminology server)

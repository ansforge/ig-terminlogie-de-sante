...
* include https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r397-categorie-entite-geographique-exercice#448 "Etab.Acc.Médicalisé en tout ou partie personnes handicapées"

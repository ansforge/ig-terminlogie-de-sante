# ASS_A12_CorresMediaTypeCDANonStructure-XdsFormatCode-CISIS - Terminologies de Santé v1.9.3
...
| Active as of 2026-06-01 | *Computable Name*:ASS_A12_CorresMediaTypeCDANonStructure_XdsFormatCode_CISIS |
| **Usage:**Workflow Task:  | |
...
```json
{
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-01T13:24:12+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{

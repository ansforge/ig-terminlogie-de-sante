...
* $unitsofmeasure#d "jour"
* $unitsofmeasure#h "heure"
* $unitsofmeasure#min "minute"
* $unitsofmeasure#s "seconde"
* $unitsofmeasure#ms "milliseconde"
* $unitsofmeasure#m "mètre"
* $unitsofmeasure#mg/dL "milligramme par décilitre"
* $unitsofmeasure#% "pourcentage"
* $unitsofmeasure#g/L "gramme par litre"
* $unitsofmeasure#cm "centimètre"
* $unitsofmeasure#kg "kilogramme"
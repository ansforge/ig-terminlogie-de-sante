...
* ^meta.versionId = "3"
* ^meta.lastUpdated = "2026-05-05T19:02:16.140+02:00"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.1.6.1.337"
...
* include codes from system $tre-r403-public-activite-smsse-regulee where niveau = "1"
# JDV UFCV Code Entree CISIS - Terminologies de Santé (Publiées par l'ANS) v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-ufcv-code-entree-cisis | *Version*:20260220142105 | |
| Active as of 2026-02-20 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvUfcvCodeEntreeCisis |
...
```json
{
  ...
  "meta" : {
    "versionId" : "6",
    "lastUpdated" : "2026-02-23T15:00:36.581+01:00",

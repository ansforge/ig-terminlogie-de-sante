# JDV_J256_Pays - Terminologies de Santé v1.4.0
...
version : 8; Dernière mise à jour : 2025-07-02 17:06:14+0000; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

Ce jeu de valeur (ValueSet) inclut les codes selon les règles suivantes :

* Inclut ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_R20-Pays/FHIR/TRE-R20-Pays`](CodeSystem-TRE-R20-Pays.md)version 📦20250328120000
...
* [codesystem TRE_R20_Pays v20250328120000 (CodeSystem)](CodeSystem-TRE-R20-Pays.md)
...
Ce jeu de valeur (ValueSet) contient 217 concepts

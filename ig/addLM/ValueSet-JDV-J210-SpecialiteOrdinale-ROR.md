# JDV_J210_SpecialiteOrdinale_ROR - Terminologies de Santé v1.4.0
...
version : 4; Dernière mise à jour : 2025-07-02 17:05:49+0000; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_R38-SpecialiteOrdinale/FHIR/TRE-R38-SpecialiteOrdinale`](CodeSystem-TRE-R38-SpecialiteOrdinale.md)version 📦20240531120000

 

### Expansion

Expansion effectuée en interne basée sur [codesystem TRE_R38_SpecialiteOrdinale v20240531120000 (CodeSystem)](CodeSystem-TRE-R38-SpecialiteOrdinale.md)

Ce jeu de valeur (ValueSet) contient 103 concepts

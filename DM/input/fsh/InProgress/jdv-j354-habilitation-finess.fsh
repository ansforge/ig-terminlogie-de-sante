Alias: $tre-r241-aide-financiere = https://mos.esante.gouv.fr/NOS/TRE_R241-AideFinanciere/FHIR/TRE-R241-AideFinanciere
...
* include codes from system $tre-r241-aide-financiere  where finess = "true" 

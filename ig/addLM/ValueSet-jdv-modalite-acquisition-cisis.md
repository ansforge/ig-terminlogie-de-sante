# JDV Modalite Acquisition CISIS - Terminologies de Santé v1.4.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-modalite-acquisition-cisis | *Version*:20251028115833 | |
| Active as of 2025-10-28 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvModaliteAcquisitionCisis |
...
* [FR-DICOM-Serie-imagerie](StructureDefinition-fr-dicom-serie-imagerie.md)
* [FR-DICOM-Technique-imagerie](StructureDefinition-fr-dicom-technique-imagerie.md)
...
version : 5; Dernière mise à jour : 2025-10-29 10:44:12+0100; Langue : fr-FR

Profil: [Shareable ValueSetversion : null4.0.1)](http://hl7.org/fhir/R4/shareablevalueset.html)

* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`http://dicom.nema.org/resources/ontology/DCM`](http://dicom.nema.org/resources/ontology/DCM)version 📦2022.4.20221006

 

### Expansion

Expansion effectuée en interne basée sur codesystem DICOM v2022.4.20221006 (CodeSystem)

Ce jeu de valeur (ValueSet) contient 49 concepts
...
```json
{
  ...
  "meta" : {
    "versionId" : "5",
    "lastUpdated" : "2025-10-29T10:44:12.308+01:00",
    "profile" : [

...
* ^url = "https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r386-macro-etat-objet-administratif?vs"
...
* include codes from system $tre-r386-macro-etat-objet-administratif
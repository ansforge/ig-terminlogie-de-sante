# Aligner les codes de présentation de la BDPM avec les codes CIP du référentiel CIP-UCD - Terminologies de Santé v1.5.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ConceptMap/alignement-bdpm-cipucd | *Version*:2025-12 | |
...
```json
{
  ...
  "meta" : {
    "versionId" : "17",
    "lastUpdated" : "2025-12-04T14:34:28.067+01:00",
    "tag" : [
      {

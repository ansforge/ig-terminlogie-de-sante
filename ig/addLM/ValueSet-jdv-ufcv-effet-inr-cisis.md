# JDV UFCV Effet INR CISIS - Terminologies de Santé v1.4.0
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans `https://www.meddra.org`version Non précisé (utilise la dernière version provenant du serveur de terminologie)

CodeSystem: TreR430ModaliteECars
Id: tre-r430-modalite-e-cars
Title: "Tre R430 Modalite ECars"
Description: "liste des modalités d'activités autorisees/exercées  en provenance de E-CARS "
* ^meta.versionId = "8"
...
* ^url = "https://smt.esante.gouv.fr/fhir/CodeSystem/:tre-r430-modalite-e-cars"
...
* #XX_03   "Structure de sevrage niveau 2 ou 3"
...
* #XX_04   "Polytraumatismes graves et complexes multiples"
...
* #XX_05   "Traumatismes cranio-cérébraux et médullaires"
...
* #XX_06   "Chirurgie complexe de la main"
...
* #XX_07   "Unités de soins palliatifs à vocation régionale"
...
* #XX_08   "Unité de soins palliatifs"
...
* #XX_09   "Unité de soins palliatifs - (médecine/SMR) - adulte "
...
* #XX_10   "Unité de soins palliatifs - (médecine/SMR) - pédiatrique"
...
* #XX_11   "ERI-SP (équipe rapide d'intervention en soins palliatifs) - HAD - adulte"
...
* #XX_12   "ERI-SP (équipe rapide d'intervention en soins palliatifs) - HAD - pédiatrique"
...
* #XX_14   "Hôpital de jour - pédiatrique"
...
* #XX_15   "Appuis territoriaux de soins palliatifs "
...
* #XX_16   "Lits identifiés (Médecine) - adulte"
...
* #XX_17   "Lits identifiés (Médecine) - pédiatrique"
...
* #XX_19   "Lits identifiés (SMR) - adulte"
...
* #XX_20   "Lits identifiés (SMR) - Pédiatrique"
...
* #XX_21   "USI Neurovasculaire - Pédiatrique"
...
* #XX_22   "Lit de Soins Intensifs -  Adulte (âge >=18 ans)"
...
* #XX_23   "USC hors champs des soins critiques"
...
* #XX_24   "Structures dites associées pour poursuite de Traitements médicamenteux systémiques du cancer (TMSC)"
...
* #XX_25   "Unité cognitivo comportementale"
...
* #XX_27   "Unité d'Hébergement Renforcée"
...
* #XX_28   "Centre de référence et de compétence"
...
* #XX_29   "Centre de référence maladies rares"
...
* #XX_31   "Unité péri-opératoire gériatrique"
...
* #XX_32   "Prise en charge des maladies d'alzheimer et apparentées"
...
* #XX_33   "Prise en charge de la maladie de parkinson et des syndromes parkinsoniens"
...
* #XX_34   "Prise en charge des patients atteints de sclérose en plaques"
...
* #XX_35   "Centre de Compétence Maladies Vectorielles à Tiques (CCMVT)"
...
* #XX_36   "Pneumologie – Adulte (âge >= 18 ans)"
...
* #XX_37   "Neurologie – Adulte (âge >= 18 ans)"
...
* #XX_39   "UAPED (Unité d’accueil pédiatrique enfance en danger )"
...
* #XX_40   "EPRRED (Equipe pédiatrique régionale référente enfance en danger)"
...
* #XX_41   "Maisons des femmes/santé"
...
* #XX_42   "DDFVV (dispositifs dédiés aux femmes victimes de violences)"
...
* #XX_45   "Unité de recours spécialisées - niveau 3 - Adultes/Pédiatriques"
* #XX_45 ^designation[0].language = #fr-FR
* #XX_45  ^property[0].code = #dateValid
* #XX_45  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_45  ^property[+].code = #dateMaj
* #XX_45  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_45  ^property[+].code = #status
* #XX_45  ^property[=].valueCode = #active
* #XX_46   "Unité de proximité spécialisée -  niveau 2 - Adultes/Pédiatriques"
* #XX_46 ^designation[0].language = #fr-FR
* #XX_46  ^property[0].code = #dateValid
* #XX_46  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_46  ^property[+].code = #dateMaj
* #XX_46  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_46  ^property[+].code = #status
* #XX_46  ^property[=].valueCode = #active
* #XX_47   "Unité d'accueil et de soins des personnes sourdes - Adultes/Pédiatriques"
* #XX_47 ^designation[0].language = #fr-FR
* #XX_47  ^property[0].code = #dateValid
* #XX_47  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_47  ^property[+].code = #dateMaj
* #XX_47  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_47  ^property[+].code = #status
* #XX_47  ^property[=].valueCode = #active
* #XX_48   "Permanence d'accès aux soins de santé (PASS) - Généraliste"
* #XX_48 ^designation[0].language = #fr-FR
* #XX_48  ^property[0].code = #dateValid
* #XX_48  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_48  ^property[+].code = #dateMaj
* #XX_48  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_48  ^property[+].code = #status
* #XX_48  ^property[=].valueCode = #active
* #XX_49   "Permanence d'accès aux soins de santé (PASS) - Mères-enfants"
* #XX_49 ^designation[0].language = #fr-FR
* #XX_49  ^property[0].code = #dateValid
* #XX_49  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_49  ^property[+].code = #dateMaj
* #XX_49  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_49  ^property[+].code = #status
* #XX_49  ^property[=].valueCode = #active
* #XX_50   "Permanence d'accès aux soins de santé (PASS) - Dentaire"
* #XX_50 ^designation[0].language = #fr-FR
* #XX_50  ^property[0].code = #dateValid
* #XX_50  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_50  ^property[+].code = #dateMaj
* #XX_50  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_50  ^property[+].code = #status
* #XX_50  ^property[=].valueCode = #active
* #XX_51   "Permanence d'accès aux soins de santé (PASS) - Psychiatrique"
* #XX_51 ^designation[0].language = #fr-FR
* #XX_51  ^property[0].code = #dateValid
* #XX_51  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_51  ^property[+].code = #dateMaj
* #XX_51  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_51  ^property[+].code = #status
* #XX_51  ^property[=].valueCode = #active
* #XX_52   "Equipe mobile psychiatrie précarité"
* #XX_52 ^designation[0].language = #fr-FR
* #XX_52  ^property[0].code = #dateValid
* #XX_52  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_52  ^property[+].code = #dateMaj
* #XX_52  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_52  ^property[+].code = #status
* #XX_52  ^property[=].valueCode = #active
* #XX_53   "CRRP (cellule régionale de régulation périnatale) "
* #XX_53 ^designation[0].language = #fr-FR
* #XX_53  ^property[0].code = #dateValid
* #XX_53  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_53  ^property[+].code = #dateMaj
* #XX_53  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_53  ^property[+].code = #status
* #XX_53  ^property[=].valueCode = #active
* #XX_54   "CRDN (centre régional de dépistage néonatal – maladies et surdité) "
* #XX_54 ^designation[0].language = #fr-FR
* #XX_54  ^property[0].code = #dateValid
* #XX_54  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_54  ^property[+].code = #dateMaj
* #XX_54  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_54  ^property[+].code = #status
* #XX_54  ^property[=].valueCode = #active
* #XX_55   "Centre de proximité pour la femme et le nouveau-né"
* #XX_55 ^designation[0].language = #fr-FR
* #XX_55  ^property[0].code = #dateValid
* #XX_55  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_55  ^property[+].code = #dateMaj
* #XX_55  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_55  ^property[+].code = #status
* #XX_55  ^property[=].valueCode = #active
* #XX_56   "Centre de référence de la mort inattendue du nourrisson"
* #XX_56 ^designation[0].language = #fr-FR
* #XX_56  ^property[0].code = #dateValid
* #XX_56  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_56  ^property[+].code = #dateMaj
* #XX_56  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_56  ^property[+].code = #status
* #XX_56  ^property[=].valueCode = #active
* #XX_57   "Maison de naissance"
* #XX_57 ^designation[0].language = #fr-FR
* #XX_57  ^property[0].code = #dateValid
* #XX_57  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_57  ^property[+].code = #dateMaj
* #XX_57  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_57  ^property[+].code = #status
* #XX_57  ^property[=].valueCode = #active
* #XX_58   "Unité hospitalière sécurisée interrégionale"
* #XX_58 ^designation[0].language = #fr-FR
* #XX_58  ^property[0].code = #dateValid
* #XX_58  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_58  ^property[+].code = #dateMaj
* #XX_58  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_58  ^property[+].code = #status
* #XX_58  ^property[=].valueCode = #active
* #XX_59   "Unité médico-judiciaire socle"
* #XX_59 ^designation[0].language = #fr-FR
* #XX_59  ^property[0].code = #dateValid
* #XX_59  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_59  ^property[+].code = #dateMaj
* #XX_59  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_59  ^property[+].code = #status
* #XX_59  ^property[=].valueCode = #active
* #XX_60   "Unité médico-judiciaire de proximité"
* #XX_60 ^designation[0].language = #fr-FR
* #XX_60  ^property[0].code = #dateValid
* #XX_60  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_60  ^property[+].code = #dateMaj
* #XX_60  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_60  ^property[+].code = #status
* #XX_60  ^property[=].valueCode = #active
* #XX_61   "Unité médico-judiciaire antenne"
* #XX_61 ^designation[0].language = #fr-FR
* #XX_61  ^property[0].code = #dateValid
* #XX_61  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_61  ^property[+].code = #dateMaj
* #XX_61  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_61  ^property[+].code = #status
* #XX_61  ^property[=].valueCode = #active
* #XX_62   "Centres de référence pour les infections ostéo-articulaires CIOA"
* #XX_62 ^designation[0].language = #fr-FR
* #XX_62  ^property[0].code = #dateValid
* #XX_62  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_62  ^property[+].code = #dateMaj
* #XX_62  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_62  ^property[+].code = #status
* #XX_62  ^property[=].valueCode = #active
* #XX_63   "Equipe mobile d’accès aux soins pour les personnes en situation de handicap - Adultes/Pédiatriques"
* #XX_63 ^designation[0].language = #fr-FR
* #XX_63  ^property[0].code = #dateValid
* #XX_63  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_63  ^property[+].code = #dateMaj
* #XX_63  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_63  ^property[+].code = #status
* #XX_63  ^property[=].valueCode = #active
* #XX_64   "Consultations dédiées pour les personnes en situation de handicap - Adultes/Pédiatriques"
* #XX_64 ^designation[0].language = #fr-FR
* #XX_64  ^property[0].code = #dateValid
* #XX_64  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_64  ^property[+].code = #dateMaj
* #XX_64  ^property[=].valueDateTime = "2026-06-11T00:00:00+01:00"
* #XX_64  ^property[+].code = #status
* #XX_64  ^property[=].valueCode = #active

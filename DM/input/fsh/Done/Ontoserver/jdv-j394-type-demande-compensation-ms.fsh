ValueSet: JdvJ394TypeDemandeCompensationMs
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.234"
...
* include codes from system https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r417-type-demande-compensation
    where status = "active"
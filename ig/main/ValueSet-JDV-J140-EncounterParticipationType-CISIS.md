# JDV_J140_EncounterParticipationType_CISIS - Terminologies de Santé v1.4.0
...
* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`https://mos.esante.gouv.fr/NOS/TRE_A13-HL7ParticipationType/FHIR/TRE-A13-HL7ParticipationType`](CodeSystem-TRE-A13-HL7ParticipationType.md)version 📦20231215120000

 

### Expansion

Expansion effectuée en interne basée sur [codesystem TRE_A13_HL7ParticipationType v20231215120000 (CodeSystem)](CodeSystem-TRE-A13-HL7ParticipationType.md)

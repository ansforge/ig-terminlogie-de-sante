...
* ^property[=].type = #dateTime
* #TERMINE "Terminé" "La ressource est totalement finie. Ce statut s'adresse aux ressources Evaluation de l'individu et Evenements liés à la prise en charge de l'individu dans une structure ESSMS. Resource achevée. Ce statut s'adresse au projet personnalisé ainsi qu'à ses ressources Action et Objectif."
* #TERMINE ^property[0].code = #dateValid
* #TERMINE ^property[=].valueDateTime = "2024-09-27T12:00:00+01:00"
* #TERMINE ^property[+].code = #dateMaj
* #TERMINE ^property[=].valueDateTime = "2025-04-25T12:00:00+01:00"
* #TERMINE ^property[+].code = #status
* #TERMINE ^property[=].valueCode = #active
* #VALIDE "Validé" "Ressource approuvée officiellement par un tiers comme le personnel de santé. Ce statut s'adresse aux ressources Evaluation de l'individu et Evenements liés à la prise en charge de l'individu dans une structure ESSMS."
* #VALIDE ^property[0].code = #dateValid
* #VALIDE ^property[=].valueDateTime = "2024-09-27T12:00:00+01:00"
* #VALIDE ^property[+].code = #dateMaj
* #VALIDE ^property[=].valueDateTime = "2025-04-25T12:00:00+01:00"
* #VALIDE ^property[+].code = #status
* #VALIDE ^property[=].valueCode = #active
* #APPROUVE "Approuvé" "Le professionnel considère la ressource comme correcte. Ce statut s'adresse aux ressources Evaluation de l'individu et Evenements liés à la prise en charge de l'individu dans une structure ESSMS."
...
* #APPROUVE ^property[=].valueDateTime = "2025-04-25T12:00:00+01:00"
* #APPROUVE ^property[+].code = #status
* #APPROUVE ^property[=].valueCode = #active
* #PLANIFIE "Planifié" "Organiser une activité à l'avance.Ce statut s'adresse aux ressources Evaluation et Evenement"
...
* #PLANIFIE ^property[=].valueDateTime = "2025-04-25T12:00:00+01:00"
* #PLANIFIE ^property[+].code = #status
* #PLANIFIE ^property[=].valueCode = #active
* #REALISE "Réalisé" "Resoource totalement effectuée. Ce statut s'adresse aux ressources Evaluation de l'individu et Evenements liés à la prise en charge de l'individu dans une structure ESSMS."
* #REALISE ^property[0].code = #dateValid
* #REALISE ^property[=].valueDateTime = "2024-09-27T12:00:00+01:00"
* #REALISE ^property[+].code = #dateMaj
* #REALISE ^property[=].valueDateTime = "2025-04-25T12:00:00+01:00"
* #REALISE ^property[+].code = #status
* #REALISE ^property[=].valueCode = #active
* #ANNULE "Annulé" "La ressource est supprimée. Ce statut s'adresse aux ressources Evaluation de l'individu et Evenements liés à la prise en charge de l'individu dans une structure ESSMS"
* #ANNULE ^property[0].code = #dateValid
* #ANNULE ^property[=].valueDateTime = "2024-09-27T12:00:00+01:00"
* #ANNULE ^property[+].code = #dateMaj
* #ANNULE ^property[=].valueDateTime = "2025-04-25T12:00:00+01:00"

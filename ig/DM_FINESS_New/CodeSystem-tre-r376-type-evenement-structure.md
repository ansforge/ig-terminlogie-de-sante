# Tre R376 Type Evenement Structure - Terminologies de Santé (Publiées par l'ANS) v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Tre R376 Type Evenement Structure**

## CodeSystem: Tre R376 Type Evenement Structure 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/CodeSystem/tre-r376-type-evenement-structure | *Version*:20241230120000 | |
| Active as of 2024-12-30 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:TreR376TypeEvenementStructure |
...
```json
{
  ...
  "name" : "TreR376TypeEvenementStructure",

...
* ^meta.versionId = "4"
* ^meta.lastUpdated = "2025-07-02T17:05:40.414+00:00"
...
* ^identifier.value = "urn:oid:1.2.250.1.213.3.4.27"
...
* $TRE-R336-TypeCrise#01 "PMIE 1"
* $TRE-R336-TypeCrise#02 "Situation sanitaire Exceptionnelle (SSE) (Plan blanc)"
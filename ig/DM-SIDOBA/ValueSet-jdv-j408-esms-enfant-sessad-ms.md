# Jdv J408 Esms Enfant Sessad Ms - Terminologies de Santé v1.8.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Jdv J408 Esms Enfant Sessad Ms**

## ValueSet: Jdv J408 Esms Enfant Sessad Ms 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-j408-esms-enfant-sessad-ms | *Version*:20260505120000 | |
| Draft as of 2026-05-05 | *Responsible:*Agence du Numérique en Santé (ANS) - 2-10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:JdvJ408EsmsEnfantSessadMs |
| *Other Identifiers:*OID:1.2.250.1.213.3.4.248 | | |

 
Orientation vers un Service d’éducation spéciale et de soins à domicile (SESSAD). 
...
```json
{
  ...
  "name" : "JdvJ408EsmsEnfantSessadMs",

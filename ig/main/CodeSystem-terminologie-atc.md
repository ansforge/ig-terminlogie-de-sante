# Classification anatomique, thérapeutique et chimique - Terminologies de Santé v1.4.0
...
This code system `https://smt.esante.gouv.fr/terminologie-atc` defines codes, but no codes are represented here

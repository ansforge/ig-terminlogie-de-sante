# ActPriority - Terminologies de Santé v1.3.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:https://smt.esante.gouv.fr/fhir/ValueSet/jdv-hl7-v3-ActPriority-cisis | *Version*:20250624152100 | |
| Active as of 2025-06-24 | *Responsible:*Agence du Numérique en Santé(ANS) -2 - 10 Rue d'Oradour-sur-Glane, 75015 Paris | *Computable Name*:ActPriority |
...
version: 4; Dernière mise à jour : 2025-06-25 09:12:22+0000; Langue : fr-FR

Profil: [Shareable ValueSet](http://hl7.org/fhir/R4/shareablevalueset.html)

* Include ce(s) code(s) tel quil(s) est (sont) défini(s) dans [`http://terminology.hl7.org/CodeSystem/v3-ActPriority`](http://terminology.hl7.org/6.5.0/CodeSystem-v3-ActPriority.html)version 📦3.0.0
...
```json
{
  ...
  "meta" : {
    "versionId" : "4",
    "lastUpdated" : "2025-06-25T09:12:22.976+00:00",

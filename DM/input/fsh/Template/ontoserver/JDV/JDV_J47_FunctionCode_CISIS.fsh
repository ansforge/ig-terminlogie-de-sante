...
* ^meta.versionId = "8"
* ^meta.lastUpdated = "2025-07-02T17:06:33.043+00:00"
...
* $TRE-R258-RelationPriseCharge#HEBERG "Centre d'hébergement"
* $TRE-R258-RelationPriseCharge#ST-PS-PEC "Structures et professionnels de proximité impliqués dans les soins"
* $TRE-R258-RelationPriseCharge#ST-COORD "Structure de coordination ou d'interface ville-hôpital"
* $TRE-R258-RelationPriseCharge#ORG-SOC "Organismes sociaux et de maintien dans l'emploi"
* $TRE-R258-RelationPriseCharge#ST-INF "Structure de soutien et d'information"
